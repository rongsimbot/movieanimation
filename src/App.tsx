...
const Navbar = ({ onStartWizard }: { onStartWizard: () => void }) => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
    ...
    <div className="flex items-center gap-4">
      <button className="px-4 py-2 text-sm font-medium hover:text-brand-primary transition-colors">Sign In</button>
      <button 
...
const UserWizard = ({ project: initialProject, onClose }: { project: MovieProject | null, onClose: () => void }) => {
  ...
  const steps = [
    { id: 1, title: 'Characters', icon: Users, desc: 'Configure character appearances and styles.' },
    { id: 2, title: 'Scenes', icon: Clapperboard, desc: 'Setup environments and camera angles.' },
    { id: 3, title: 'Animation', icon: Cpu, desc: 'Define motion paths and expression styles.' },
...
export default function App() {
  ...
  const trendingMovies: SampleMovie[] = [
    { id: '1', title: 'Stardust Odyssey', thumbnail: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?q=80&w=2072&auto=format&fit=crop', category: 'Sci-Fi' },
    { id: '2', title: 'Cosmic Horizons', thumbnail: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop', category: 'Adventure' },
    { id: '3', title: 'The Void Within', thumbnail: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=2011&auto=format&fit=crop', category: 'Thriller' },
    { id: '4', title: 'Galactic Empires', thumbnail: 'https://images.unsplash.com/photo-1446941611757-91d2c3bd3d45?q=80&w=2002&auto=format&fit=crop', category: 'Action' },
    { id: '5', title: 'Alien Encounters', thumbnail: 'https://images.unsplash.com/photo-1506318137071-a8e063b4bcc0?q=80&w=2070&auto=format&fit=crop', category: 'Mystery' },
    { id: '6', title: 'Starship Chronicles', thumbnail: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=2094&auto=format&fit=crop', category: 'Drama' },
  ];
